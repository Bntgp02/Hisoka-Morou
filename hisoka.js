...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/2b3e56825c5e775dbf1e3.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Prices\n⭔ 5k Per Group via E-Walet 1 Month\n⭔ 9k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 1k per User 1 bulan` }, { quoted: m })
           }
           break
           case 'sc': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/bintangp02'
                                }
                            }, {
                                callButton: {
...
⭔ Url : ${anu.url}`,
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
	        ...
	        case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('bin', '/api/download/tiktok', { url: text }, 'apikey'))
                let buttons = [
